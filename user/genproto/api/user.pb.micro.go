...
type UserService interface {
	...
	Pub(ctx context.Context, in *proto1.Request, opts ...client.CallOption) (*proto1.Response, error)
}
...
func (c *userService) Pub(ctx context.Context, in *proto1.Request, opts ...client.CallOption) (*proto1.Response, error) {
	req := c.c.NewRequest(c.name, "User.Pub", in)
	out := new(proto1.Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type UserHandler interface {
	...
	Pub(context.Context, *proto1.Request, *proto1.Response) error
}
...
func RegisterUserHandler(s server.Server, hdlr UserHandler, opts ...server.HandlerOption) error {
	type user interface {
		...
		Pub(ctx context.Context, in *proto1.Request, out *proto1.Response) error
	}
	type User struct {
		user
	}
...
func (h *userHandler) Pub(ctx context.Context, in *proto1.Request, out *proto1.Response) error {
	return h.UserHandler.Pub(ctx, in, out)
}
